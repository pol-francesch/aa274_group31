...
struct DetectedObjectList_
{
  ...
  _objects_type objects;
   ...
   typedef std::vector< ::asl_turtlebot::DetectedObject_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::asl_turtlebot::DetectedObject_<ContainerAllocator> >> _ob_msgs_type;
...
bool operator==(const ::asl_turtlebot::DetectedObjectList_<ContainerAllocator1> & lhs, const ::asl_turtlebot::DetectedObjectList_<ContainerAllocator2> & rhs)
{
  return lhs.objects == rhs.objects &&
    lhs.ob_msgs == rhs.ob_msgs;
}
